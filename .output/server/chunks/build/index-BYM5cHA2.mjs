...
import { u as useMock } from './useMockData-DQEsZ1OI.mjs';
...
const _sfc_main$1 = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-db54ae1a><div class="block lg:hidden text-14 h-full w-full md:w-md px-32 md:px-16" data-v-db54ae1a><div class="flex flex-wrap justify-between items-center h-full py-8" data-v-db54ae1a><img class="h-30"${ssrRenderAttr("src", `/${name.value}/header_logo.png`)} alt="404" data-v-db54ae1a><img style="${ssrRenderStyle(scrollPosition.value > 2 ? null : { display: "none" })}" class="w-30 h-30 p-4"${ssrRenderAttr("src", _imports_0$1)} data-v-db54ae1a><img style="${ssrRenderStyle(scrollPosition.value <= 2 ? null : { display: "none" })}" class="w-30 h-30 p-4"${ssrRenderAttr("src", _imports_1$1)} data-v-db54ae1a></div>`);
      _push(ssrRenderComponent(_component_el_drawer, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex justify-end p-16" data-v-db54ae1a${_scopeId}><img class="w-20 h-20"${ssrRenderAttr("src", _imports_2$1)} alt="" data-v-db54ae1a${_scopeId}></div><div class="w-full flex-col" data-v-db54ae1a${_scopeId}><!--[-->`);
            ssrRenderList(list, (item) => {
              _push2(`<div class="w-full p-14 border-0 border-b-[1px] border-solid border-000-1 justify-center items-center" data-v-db54ae1a${_scopeId}>${ssrInterpolate(_ctx.$t(item.name))}</div>`);
            });
            _push2(`<!--]--></div>`);
          } else {
            return [
      ...
      _push(`</div><div class="hidden lg:block transition-all duration-500 text-14 h-full w-lg xl:w-xl" data-v-db54ae1a><div class="flex flex-wrap justify-between items-center h-full px-28 py-8" data-v-db54ae1a><img class="h-34"${ssrRenderAttr("src", `/${name.value}/header_logo.png`)} alt="404" data-v-db54ae1a><div class="flex flex-wrap items-center" data-v-db54ae1a><!--[-->`);
      ssrRenderList(list, (item, index) => {
        _push(`<a class="${ssrRenderClass([scrollPosition.value > 2 ? "text-000" : "text-fff", "px-12 py-8 font-600 cursor-pointer"])}"${ssrRenderAttr("href", `#${item.id}`)} data-v-db54ae1a>${ssrInterpolate(item.name)}</a>`);
      });
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc$1(_sfc_main$1, [["__scopeId", "data-v-db54ae1a"]]);
...
//# sourceMappingURL=index-BYM5cHA2.mjs.map
