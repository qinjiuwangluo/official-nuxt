...
import { isBoolean as isBoolean$1, makeSymbol, isPlainObject, isString as isString$1, isArray, isRegExp, isFunction, inBrowser, create, deepCopy, hasOwn, isObject, assign, isNumber as isNumber$1, isEmptyObject, getGlobalThis } from '@intlify/shared';
import { DEFAULT_LOCALE, updateFallbackLocale, createCompileError, setFallbackContext, createCoreContext, clearDateTimeFormat, clearNumberFormat, setAdditionalMeta, getFallbackContext, NOT_REOSLVED, CORE_ERROR_CODES_EXTEND_POINT, fallbackWithLocaleChain, parseTranslateArgs, translate, MISSING_RESOLVE_VALUE, parseDateTimeArgs, datetime, parseNumberArgs, number, isMessageAST, isMessageFunction, NUMBER_FORMAT_OPTIONS_KEYS, DATETIME_FORMAT_OPTIONS_KEYS, registerMessageCompiler, compile, registerMessageResolver, resolveValue, registerLocaleFallbacker, setDevToolsHook } from '@intlify/core-base';
...
const _routes = [
  ...
  },
  {
    name: "private",
    path: "/private",
    component: () => import('./private.vue.mjs')
  },
  {
    name: "user_policy",
    path: "/user_policy",
    component: () => import('./user_policy.vue.mjs')
  },
  {
    name: "information_sharing",
    path: "/information_sharing",
    component: () => import('./information_sharing.vue.mjs')
  },
  {
    name: "civizatio_convention",
    path: "/civizatio_convention",
    component: () => import('./civizatio_convention.vue.mjs')
  },
  {
    name: "member_ship_agreement",
    path: "/member_ship_agreement",
    component: () => import('./member_ship_agreement.vue.mjs')
  },
  {
    name: "persoInfor_disclosure",
    path: "/persoInfor_disclosure",
    component: () => import('./persoInfor_disclosure.vue.mjs')
  },
  {
    name: "information_protection",
    path: "/information_protection",
    component: () => import('./information_protection.vue.mjs')
  }
];
...
export { useNuxtApp as a, useRuntimeConfig as b, nuxtLinkDefaults as c, useNamespace as d, isNumber as e, isStringNumber as f, isUndefined as g, isBoolean as h, isElement as i, useZIndex as j, useId as k, defaultNamespace as l, useAppConfig as m, navigateTo as n, asyncDataDefaults as o, createError as p, resolveRouteObject as r, server as s, tryUseNuxtApp as t, useRouter as u };
