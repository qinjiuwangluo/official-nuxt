...
import { makeSymbol, assign, isNumber as isNumber$1, create, isString as isString$1, isObject, isEmptyObject, getGlobalThis, isBoolean as isBoolean$1, isArray, isPlainObject, isRegExp, isFunction, inBrowser, deepCopy, hasOwn } from '@intlify/shared';
import { registerMessageCompiler, compile, registerMessageResolver, resolveValue, registerLocaleFallbacker, fallbackWithLocaleChain, setDevToolsHook, CORE_ERROR_CODES_EXTEND_POINT, createCompileError, DEFAULT_LOCALE, updateFallbackLocale, NUMBER_FORMAT_OPTIONS_KEYS, DATETIME_FORMAT_OPTIONS_KEYS, setFallbackContext, createCoreContext, clearDateTimeFormat, clearNumberFormat, setAdditionalMeta, getFallbackContext, NOT_REOSLVED, parseTranslateArgs, translate, MISSING_RESOLVE_VALUE, parseDateTimeArgs, datetime, parseNumberArgs, number, isMessageAST, isMessageFunction } from '@intlify/core-base';
...
const _routes = [
  {
    ...
    component: () => import('./civizatio_convention-CltWy4my.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-Cd1fgTJL.mjs')
  },
  {
    name: "information_protection",
    path: "/information_protection",
    component: () => import('./information_protection-BCxZQ4sV.mjs')
  },
  {
    name: "information_sharing",
    path: "/information_sharing",
    component: () => import('./information_sharing-CDtHcY6m.mjs')
  },
  {
    name: "member_ship_agreement",
    path: "/member_ship_agreement",
    component: () => import('./member_ship_agreement-DXg-nu78.mjs')
  },
  {
    name: "persoInfor_disclosure",
    path: "/persoInfor_disclosure",
    component: () => import('./persoInfor_disclosure-ByR5xp9s.mjs')
  },
  {
    name: "private",
    path: "/private",
    component: () => import('./private-CIRs8B0j.mjs')
  },
  {
    name: "user_policy",
    path: "/user_policy",
    component: () => import('./user_policy-DrkNdIBU.mjs')
  }
];
...
function useCookie(name, _opts) {
  ...
  const cookieValue = klona(hasExpired ? undefined : cookies2[name] ?? ((_a = opts.default) == null ? undefined : _a.call(opts)));
...
const element_plus_teleports_plugin_h4Dmekbj62 = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  nuxtApp.hook("app:rendered", (ctx) => {
    var _a;
    if ((_a = ctx.ssrContext) == null ? undefined : _a.teleports) {
...
const en = {
  ...
  more: "More",
  openGooglePlay: "Redirecting to Google Play",
  openAppStore: "Redirecting to App Store",
  All: "All",
  "Please use mobile phone to scan the QR code to download.": "Please use mobile phone to scan the QR code to download.",
  "Or copy the link, open it with your mobile browser to download.": "Or copy the link, open it with your mobile browser to download.",
  "Click to copy the link.": "Click to copy the link.",
  Community: "Community",
  "Contact Us": "Contact Us",
  Copyright: `Copyright{'@'}2024.GUYAN TV All rights reserverd.`,
  app: {
    "Copied successfully": "Copied successfully.",
    "Guyan TV - Enjoy Every Moment, Binge on Your Favorite Shows!": "Guyan TV - Enjoy Every Moment, Binge on Your Favorite Shows!",
    "APP Info": "Had a long day at work and feeling stressed? Need to relax during your lunch break?<br>Guyan TV offers a wide variety of shows to suit your mood, whether it's a lighthearted comedy or a gripping suspense drama, we’ve got something for every moment.<br>Whether you're into movies or hooked on short dramas, we provide a fresh visual experience with continuous, exciting content!<br>Download Guyan TV now and make every moment fun!"
  }
};
const setCurrLang = () => {
  return "en";
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-B374E8zP.mjs').then((m) => m.default || m))
};
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({
        ...
        class: [isLoading.value ? "block " : "hidden"]
      }, _attrs), {
