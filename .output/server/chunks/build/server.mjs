...
const _routes = [
  ...
  },
  {
    name: "private",
    path: "/private",
    component: () => import('./private-FkWHttUI.mjs')
  },
  {
    name: "user-policy",
    path: "/user-policy",
    component: () => import('./user-policy-Cwjn20CP.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-BcWF18Wa.mjs').then((m) => m.default || m))
};
