<template>
  <div class="w-full flex justify-center md:px-32 md:py-32 leading-1.6">
    <div class="max-w-[840px] bg-fff md:rounded-8 shadow-2xl p-20">
      ...
      <div class="text">
        Children should obtain the consent of their guardians before using our
        products and services. If your child is a child under the age of 14,
        he/she needs your consent and under your guardianship and guidance when
        using the Ancient Language Theater APP in normal mode. If you disagree
        with him/her using the Ancient Language Theater APP in normal mode,
      ...
      <div class="text">
        This platform will adopt professional encryption storage and
        transmission methods to ensure the security of your information and will
      ...
      <div class="text">
        ...
        provide you with our products or services. We will clearly show you the
        purpose, method, and scope of collecting and using personal information
        in the “Privacy Policy”, and collect information after obtaining your
      ...
      <div class="text">
        We will deliver the notice of stopping operation to you in the form of
        an announcement.
      </div>
      ...
      <ul>
        ...
        <li>
          You have withdrawn your consent and we are still collecting and using
          it;
        </li>
        <li>
          Children or their guardians terminate the use of products or services
          through cancellation and other methods.
        </li>
      </ul>
      ...
      <div class="text">
        After verifying your identity, we will process it according to your
      ...
      <div class="text">
        If you want to make a complaint, report, or have any other questions,
        you can contact us through the following ways, and we will do our best
        to handle it for you within the scope of laws and regulations.
      </div>
      <ul>
        <li>Customer service phone: 400-118-0066</li>
      ...
      <div class="text">
        The “Privacy Policy” shows the general practices of the Ancient Language
      ...
      <div class="sub_title_1 text-16 md:text-20">
        ...
        be applicable/refer to the “Privacy Policy” according to the actual
        situation of the product.
      </div>

      <div class="text">
        Unless otherwise stated in this rule, the meaning of the words involved
        in this rule is consistent with the meaning in the text of the “Privacy
        Policy”.
      </div>
    </div>
  </div>
