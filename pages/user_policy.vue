    ...
    <div class="max-w-[840px] bg-fff md:rounded-8 shadow-2xl p-20">
      ...
      <div class="text">
        ...
        Agreement” (hereinafter referred to as the “Agreement”) is made by [{{
          data.name_up
        }}] (hereinafter referred to as “we” or “platform”) and you (hereinafter
        referred to as “user”) regarding the short drama viewing service
        provided by [{{ data.name_up }}]. Please read the following terms
        carefully before using our platform services. Your login, viewing, or
        other use of our platform services is considered as your full
        understanding and agreement to accept the constraints of all terms of
        this Agreement.
      </div>
